...
**Codex note:** Codex does not support subagents. Use this workflow as a manual checklist: treat "implementer", "spec reviewer", and "code quality reviewer" as distinct self-review passes, and use the prompt templates as guidance rather than Task tool invocations.
