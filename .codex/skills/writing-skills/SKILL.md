...
**Personal skills live in `~/.codex/skills` and repo-scoped skills live in `.codex/skills`** 
...
**Worked example:** See references/examples/CLAUDE_MD_TESTING.md for a full test campaign.
